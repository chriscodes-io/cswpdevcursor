...
async def send_password_reset(name: str, email: str, reset_url: str) -> Optional[str]:
    ...
    body = f"""
      ...
      <p style="color:{MUTED};font-size:13px;">This link expires in 1 hour. If you did not request a reset, you can ignore this email.</p>
    """
    html = _wrap_html("Reset your password", body, cta={"label": "Reset password", "url": reset_url})
    text = f"Reset your password: {reset_url}\n\nThis link expires in 1 hour."
    return await _send(email, "Reset your password", html, text=text)
