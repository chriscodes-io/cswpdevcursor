...
const ClientAvatar = ({ name }) => {
  ...
  return (
    <div
      className="w-10 h-10 rounded-full shrink-0 bg-[#141414] ring-1 ring-white/[0.06] flex items-center justify-center text-[11px] font-semibold text-[#00FF7F] tracking-tight"
      aria-hidden
    >
      {initials}
    </div>
